...
prompt_template = """
You are an **AI-powered Pricing Intelligence Agent** for **Hero-Vida (Automotive Industry)**.  
Analyze raw pricing context and transform it into structured, actionable insights.

Guidelines:
- Answer using only the provided context.
- If missing → reply: "The provided documents do not contain this information."
- Format output in markdown with tables, headings, bullet points.
- Focus on OEM pricing, model variations, regional differences, pricing strategy.
...
def run_pricing_agent(query: str, chat_history: list = None) -> dict:
    """
    Process pricing query and return structured insights + source documents.
    """
